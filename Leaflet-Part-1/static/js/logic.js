...
console.log(data)
  ...
  function styleInfo(feature) {
    return {
    color: "white",
    //*******Might need to put feature.features********* AJ notes
  ...
  //********If this doesn't work look at NYC Bouroughs logic4.js
  ...
  legend.onAdd = function (map) {
    ...
    let depthIntervals= ["Greater than 50km", "49-20km", "19-10km", "Less than 10km"];
    let labelColors = ["red", "orange", "yellow", "green"];
    let labels = [];
    // Loop through our depth intervals to generate a label with a colored square for each interval.
    for (let i = 0; i < depthIntervals.length - 1; i++) {
      labels.push(
          '<i style="background:' + labelColors[i] + '"></i> ' +
          depthIntervals[i]
      );
  } 
